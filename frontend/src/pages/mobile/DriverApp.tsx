...
import { Map, Navigation, CheckCircle, Camera, PenTool } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto bg-gray-50 h-[800px] border-[8px] border-gray-900 rounded-[2.5rem] overflow-hidden shadow-2xl relative flex flex-col">
      ...
      <div className="bg-navy-900 text-white p-4 flex items-center justify-between pb-6">
        <div>
          ...
          <p className="text-sm text-navy-300">3 stops remaining</p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 -mt-3">
        <Card className="mb-4 shadow-md border-0">
          <CardContent className="p-4 space-y-4">
            ...
            <Button size="lg" className="w-full h-14 text-lg bg-navy-900 hover:bg-navy-800">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <Button variant="outline" className="h-24 flex flex-col items-center justify-center space-y-2 border-navy-200 bg-white shadow-sm">
        ...
        <Button size="lg" className="w-full h-14 text-lg bg-success-500 hover:bg-success-600">
          <CheckCircle className="h-5 w-5 mr-2" /> Complete Delivery
        </Button>
      </div>

      {/* Mobile Bottom Navigation */}
      <div className="h-16 bg-white border-t border-navy-200 flex items-center justify-around text-navy-400 text-xs">
